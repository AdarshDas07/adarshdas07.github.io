...
const academicLinks = [
  ...
  { Icon: GithubIcon, text: 'GitHub', href: 'https://github.com/adarsh07' },
  { Icon: LinkedInIcon, text: 'LinkedIn', href: '#', colorClass: 'text-[#007BB6]' },
];
          ...
          <ul className="mt-4 space-y-6">
            {recentActivitiesTimeline.map((item, index) => (
              <li key={index} className="flex flex-col sm:flex-row gap-2 sm:gap-6">
                <p className="font-mono text-sm text-gray-500 w-full sm:w-40 flex-shrink-0">{item.date}</p>
